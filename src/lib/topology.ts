...
export const DEMO_BRANCHES: TopoBranch[] = [
  makeBranch("B1", "U1", "N1", { type: "Ствол ЮВС",   layer: "Стволы",    horizonId: "H_-75",  shape: "round", diameter: 7,
                                  ...
                                  flow: 100, vMax: 15 }),
  makeBranch("B2", "N1", "N2", { type: "Квершлаг",    layer: "Квершлаги", horizonId: "H_-75",  shape: "arch",  rectWidth: 5, rectHeight: 3.5, archHeight: 1.5,
                                  surfaceId: "concrete", surface: "Бетонная крепь гладкая", alphaCoef: 12, roughness: 3,
                                  flow: 100 }),
  makeBranch("B3", "N2", "N3", { type: "Уклон",       layer: "Уклоны",    horizonId: "H_-240", shape: "rect",  rectWidth: 5, rectHeight: 3.5,
                                  surfaceId: "anchor", surface: "Анкерная крепь", alphaCoef: 30, roughness: 50,
                                  flow: 100 }),
  makeBranch("B4", "N3", "N4", { type: "Штрек откат.",layer: "Штреки",    horizonId: "H_-240", shape: "arch",  rectWidth: 5, rectHeight: 2.5, archHeight: 1.5,
                                  surfaceId: "metal_arch", surface: "Металлическая арочная крепь", alphaCoef: 40, roughness: 60,
                                  flow: 100 }),
  makeBranch("B5", "N4", "N5", { type: "Очистной",    layer: "Лавы",      horizonId: "H_-240", shape: "rect",  rectWidth: 5, rectHeight: 2,
                                  surfaceId: "lava", surface: "Очистной забой (лава)", alphaCoef: 80, roughness: 120,
                                  flow: 100, localXi: 3 }),
  makeBranch("B6", "N5", "N6", { type: "Штрек вент.", layer: "Штреки",    horizonId: "H_-75",  shape: "arch",  rectWidth: 5, rectHeight: 2.5, archHeight: 1.5,
                                  surfaceId: "metal_arch", surface: "Металлическая арочная крепь", alphaCoef: 40, roughness: 60,
                                  flow: 100 }),
