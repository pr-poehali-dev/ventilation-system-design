...
export interface TopoBranch {
  ...
  manualR: number;          // кМюрг (кгс·с²/м⁸) — ручной ввод, как в АэроСети
...
export function recalcBranchAero(b: TopoBranch, rho = 1.2): TopoBranch {
  ...
  // Ручной ввод R задаётся в кМюрг — как во всех формулах (α, шероховатость,
  // трубопровод) и как в АэроСети. Перевод кМюрг → Н·с²/м⁸ (×9,81) выполняется
  // ОДИН РАЗ в calcResistance, общий для всех способов задания.
