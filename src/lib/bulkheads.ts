...
// Сопротивление перемычки с РЕГУЛИРУЕМЫМ ОКНОМ в НАШИХ единицах (Н·с²/м⁸,
// ΔP = R·Q² сразу в Па — как все прочие сопротивления в этом коде). Формула
// истечения через отверстие (диафрагму): перепад определяется СКОРОСТЬЮ ВОЗДУХА
// В ОКНЕ (Q/Sок), а не в сечении выработки:
//   ΔP = ρ/2 · (Q/(μ·Sок))²  ⇒  R = ρ / (2·μ²·Sок²)
// где ρ=1,2 кг/м³, μ=0,75. Проверка (эталон АэроСети):
//   Sок=5,5 → R≈0,0353 Н·с²/м⁸ = 0,0036 кМюрг(кгс) → ΔP≈536 Па.
