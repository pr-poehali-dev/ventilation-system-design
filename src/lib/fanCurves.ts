...
export const FAN_CATALOG: FanCurve[] = [
  ...
  // ─── Korfmann (осевые главного проветривания, реверсивные) ──────────────────
  {
    ...
    // Паспортная кривая напора (верхняя синяя, угол 21°, 1000 об/мин):
    //   H(56)≈1000, H(80)≈820, H(104)≈600 Па → H = 1264 − 2.778·Q − 0.0347·Q²
    // Проверка рабочей точки ГВУ №1: Q=93.1 → H≈706 Па (паспорт H=705 Па ✓)
    // Мощность на графике 90..96 кВт, КПД в рабочей зоне ~75%
    ...
    reverseH0: 758, reverseH1: -1.667, reverseH2: -0.02083,
