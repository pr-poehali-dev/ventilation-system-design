...
export const FAN_CATALOG: FanCurve[] = [
  ...
  },
  {
    ...
    // Характеристика H(Q)=h0+h1·Q+h2·Q² для угла лопаток 30°, 1500 об/мин.
    // Построена по 3 паспортным точкам (как в «Вентиляция 2.0»/«АэроСеть»):
    //   Q=23,22 → H=3241 Па, N=139,9 кВт, η=54%
    //   Q=31,01 → H=2884 Па, N=135,1 кВт, η=66%
    //   Q=38,81 → H=1342 Па, N=97,5  кВт, η=53%
    // Диапазон углов [20;40] симметричен вокруг 30° → множитель угла = 1,0 на 30°,
    // т.е. паспортная кривая берётся как есть.
    h0: -2709.001, h1: 482.4339, h2: -9.74114,
    e0: -1.29895, e1: 0.12696, e2: -0.002057,
