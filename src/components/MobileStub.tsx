  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center"
      ...
      <div className="mb-8 flex items-center gap-3">
        <img src="https://cdn.poehali.dev/projects/564c75d6-cb0f-4378-9852-c88803b7dcf2/bucket/f615a5b6-1200-469a-956d-b8be955dd6d0.png" alt="ПВ-Система" className="w-10 h-10 object-contain" draggable={false} />
