...
# Перевод кгс/м² (мм вод. ст.) → Па. Сопротивление приходит с фронтенда в
# кМюрг (кгс·с²/м⁸), поэтому R·Q² даёт мм вод. ст., а напор вентилятора задан
# в Па. Без этого множителя в уравнении контура складывались разные единицы:
# сопротивление сети занижалось в 9,81 раза и расход выходил завышенным.
PA_PER_MM_H2O = 9.81


def get_R(b):
    """Сопротивление ветви, приведённое к Па·с²/м⁶ (чтобы R·Q² давало паскали)."""
    ...
    return max(r, 1e-4) * PA_PER_MM_H2O
